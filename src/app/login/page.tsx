    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2 text-sm">Accédez à votre espace client</p>
        </div>

        <div className="card p-8">
          <h1 className="text-2xl font-extrabold text-gray-900 mb-6">Connexion</h1>
          ...
          >
            ...
            <button type="submit" className="w-full btn-gradient justify-center py-3.5">
              Se connecter →
            </button>
          </form>
          ...
          >
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 border border-gray-200 rounded-xl py-3.5 text-sm font-semibold text-gray-700 hover:bg-gray-50 transition-colors"
            >
